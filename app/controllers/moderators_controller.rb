class ModeratorsController < ApplicationController
  ...
  def moderator_email
    @secret_list = User.all
    @moderator = Moderator.first

    UserMailer.with(email: @moderator.email, name: @moderator.name, secret_list: @secret_list).moderator.deliver_now
  end
  ...
  private
    ...
    def moderator_params
      params.require(:moderator).permit(:name, :email)
    end
end
